#!/usr/bin/env node
// One-off: create a Zippy board for Octopus Monster Truck, look it up if it already exists, and print the board id.
...
const BOARD_NAME = "Octopus Monster Truck Coloring Pages";
const CAT_ID = "cat-octopus-monster-truck-coloring-pages";
