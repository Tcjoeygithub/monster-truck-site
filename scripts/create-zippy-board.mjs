#!/usr/bin/env node
// One-off: create a Zippy board, look it up if it already exists, and print the board id.
...
const BOARD_NAME = "Werewolf Monster Truck Coloring Pages";
const CAT_ID = "cat-werewolf-monster-truck-coloring-pages";
