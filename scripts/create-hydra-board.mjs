#!/usr/bin/env node
// One-off: create a Zippy board for Hydra Monster Truck, look it up if it already exists, and print the board id.
...
const BOARD_NAME = "Hydra Monster Truck Coloring Pages";
const CAT_ID = "cat-hydra-monster-truck-coloring-pages";
