#!/usr/bin/env node
// One-off: create a Zippy board for Pegasus Monster Truck, look it up if it already exists, and print the board id.
...
const BOARD_NAME = "Pegasus Monster Truck Coloring Pages";
const CAT_ID = "cat-pegasus-monster-truck-coloring-pages";
