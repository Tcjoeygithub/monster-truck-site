#!/usr/bin/env node
// One-off: create a Zippy board for Cerberus Monster Truck, look it up if it already exists, and print the board id.
...
const BOARD_NAME = "Cerberus Monster Truck Coloring Pages";
const CAT_ID = "cat-cerberus-monster-truck-coloring-pages";
