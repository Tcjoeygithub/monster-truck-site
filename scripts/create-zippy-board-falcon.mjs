#!/usr/bin/env node
// One-off: create a Zippy board for Falcon Monster Truck, look it up if it already exists.
...
const BOARD_NAME = "Falcon Monster Truck Coloring Pages";
const CAT_ID = "cat-falcon-monster-truck-coloring-pages";
