#!/usr/bin/env node
// One-off: create a Zippy board for Kraken Monster Truck, look it up if it already exists.
...
const BOARD_NAME = "Kraken Monster Truck Coloring Pages";
const CAT_ID = "cat-kraken-monster-truck-coloring-pages";
