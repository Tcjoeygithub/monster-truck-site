#!/usr/bin/env node
// One-off: create a Zippy board for Komodo Dragon Monster Truck, look it up if it already exists.
...
const BOARD_NAME = "Komodo Dragon Monster Truck Coloring Pages";
const CAT_ID = "cat-komodo-dragon-monster-truck-coloring-pages";
