#!/usr/bin/env node
// One-off: create a Zippy board for Mammoth Monster Truck, look it up if it already exists.
...
const BOARD_NAME = "Mammoth Monster Truck Coloring Pages";
const CAT_ID = "cat-mammoth-monster-truck-coloring-pages";
